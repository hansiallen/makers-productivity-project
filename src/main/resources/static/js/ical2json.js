// Taken from Adian Lee's ical2json nodejs library (couldn't directly use it as it contains some stuff incompatible with vanillajs, but this subroutine is useful
